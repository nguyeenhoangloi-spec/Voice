...
def _refine_with_gemini_vision(segments: list, keyframes: dict, api_key: str):
    ...
    for batch_idx, batch in enumerate(batches):
        try:
            ...
            # Explicitly instruct Gemini to return an "index" field to track image-result pairs.
            instruction = (
            ...
            if json_match:
                try:
                    ...
                    # Create a map from index -> response_item.
                    # This protects the system from crashes due to missing/extra JSON elements.
                    refined_map = {}
                    ...
                    # Apply results to matched segments by local index
                    updated_count = 0
                    for idx_in_batch, (seg_idx, seg) in enumerate(batch):
...
def translate_segments(segments: list, target_lang: str = "vi", video_context: str = "neutral", video_topic: str = "") -> list:
    ...
    # Filter only pending segments that don't have a translation yet.
    # This prevents overwriting high-quality translations generated by Gemini Vision (Layer 2)
    # or direct user corrections in the database.
